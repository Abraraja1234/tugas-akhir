...
<body>
    <header class="px-4 py-2 shadow bg-white">
        <div class="flex justify-between items-center">
            <button class="p-4 focus:outline-none" type="button" aria-label="Menu">
                <svg class="w-5" viewBox="0 -21 384 384">
            ...
            <button class="p-4 md:hidden focus:outline-none" type="button" aria-label="Search">
            ...
            <div class="relative hidden md:inline-block">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="w-4 fill-current text-gray-500" viewBox="0 0 512 512">
                        <path d="M225.474 0C101.151 0 0 101.151 0 225.474c0 124.33 101.151 225.474 225.474 225.474 124.33 0 225.474-101.144 225.474-225.474C450.948 101.151 349.804 0 225.474 0zm0 409.323c-101.373 0-183.848-82.475-183.848-183.848S124.101 41.626 225.474 41.626s183.848 82.475 183.848 183.848-82.475 183.849-183.848 183.849z" />
                        <path d="M505.902 476.472L386.574 357.144c-8.131-8.131-21.299-8.131-29.43 0-8.131 8.124-8.131 21.306 0 29.43l119.328 119.328A20.74 20.74 0 00491.187 512a20.754 20.754 0 0014.715-6.098c8.131-8.124 8.131-21.306 0-29.43z" />
                    </svg>
                </div>
                <input type="text" placeholder="Search" name="search" id="search" class="block w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 focus:ring-blue-500">
            </div>

            <div class="flex items-center">
                <button class="p-3 mr-2 focus:outline-none hover:bg-gray-100 hover:rounded-md" type="button" aria-label="Messages">
                    <svg class="w-5 fill-current" viewBox="0 0 512 512">
                ...
                <button class="p-3 mr-3 focus:outline-none hover:bg-gray-100 hover:rounded-md" type="button" aria-label="Notifications">
                    <svg class="w-5 fill-current" viewBox="-21 0 512 512">
                ...
                <button class="flex items-center p-3 focus:outline-none hover:bg-gray-100 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = !open" :class="{ 'bg-gray-100 rounded-md': open }" aria-label="Profile" aria-haspopup="true" aria-expanded="open">
                    ...
                    <span class="ml-2 text-sm hidden md:inline-block">Admin</span>
                    <svg class="w-3 ml-2 fill-current" viewBox="0 0 407.437 407.437">
                        <path d="M386.258 91.567l-182.54 181.945L21.179 91.567 0 112.815 203.718 315.87l203.719-203.055z" />
                    </svg>

                    <div class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
    ...
    <div class="flex">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-gray-900 border-r dark:border-gray-700">
